...
import { ArrowLeftIcon, StarIcon, ChevronRightIcon, QuestionMarkCircleIcon } from 'react-native-heroicons/solid';
      ...
      <View className='bg-white'>
        <View className='px-4 pt-4'>
          ...
          <View className='flex-row space-x-2 my-1'>
            ...
            <View className='flex-row space-x-2 my-1'>
              <FontAwesomeIcon icon={faLocationDot} color='gray' opacity={0.4} size={22} />
